...
namespace KitapProjesi.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Book.Include(b => b.Category).Include(b => b.Publisher);
        ...
        public async Task<IActionResult> Create([Bind("ISBN,BookName,publishYear,Description,ImageUrl,CategoryId,PublisherId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("ISBN,BookName,publishYear,Description,ImageUrl,CategoryId,PublisherId")] Book book)
        {
            if (id != book.ISBN)
            {
                return NotFound();
